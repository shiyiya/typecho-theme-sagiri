...
},{"./affix":1,"./donpay":2,"./imgview":3,"./mouse":5,"./sidebar":6,"./totop":7,"./type":8}],5:[function(require,module,exports){
"use strict";
...
!Sagiri.util.isMobile && function () {
  ...
  if (sidebarNavToc) {
    var tocList = document.querySelector('.toc-list'),
        ...
        tocTitleList = [].slice.call(postWrap.querySelectorAll('h1, h2, h3, h4, h5, h6'));

    sidebarOverview.onclick = function () {
      var _this = this;

      this.classList.add('sidebar-nav-active');
      [].slice.call(this.parentElement.children).map(function (_) {
        if (_ !== _this) _.classList.remove('sidebar-nav-active');
      });
    ...
    sidebarNavToc.onclick = function () {
      ...
      this.classList.add('sidebar-nav-active');
      [].slice.call(this.parentElement.children).map(function (_) {
        if (_ !== _this2) _.classList.remove('sidebar-nav-active');
      });
  ...
  if (siderOther) {
    var siderOtherNavs = [].slice.call(siderOther.querySelectorAll('.sidebar-nav > li')),
    ...
    if (siderOther.childElementCount > 1) {
      ...
      siderOtherNavs.forEach(function (nav, key) {
        nav.onclick = function () {
          ...
          siderOtherSections.filter(function (_) {
            return _ != siderOtherSections[key];
          }).forEach(function (_) {
...
var backToTop = function backToTop() {
  ...
  return function () {
    ...
    var interval = setInterval(function () {
      var next = Math.floor(Sagiri.util.easeInOutQuad(10 * i, start, -start, 100));
...
var animatedText = document.getElementById('animate');
var guideText = document.getElementById('guide'); // select the spans in in the guide

var guideSpans = guideText.getElementsByTagName('span'); // select the spans in in the guide

var animatedSpans = animatedText.getElementsByTagName('span');
var textLength = guideSpans.length;

var placeSpans = function placeSpans() {
  // for each span in the guide
  for (var i = 0; i < textLength; i++) {
    var guide = guideSpans[i];
    var animated = animatedSpans[i]; // get the guide client rect

    var rect = guide.getBoundingClientRect(); // set the left property of the animate
    // span to rect.left
...
var animateLetterIn = function animateLetterIn(i) {
  setTimeout(function () {
...
var animateLetterOut = function animateLetterOut(i) {
  setTimeout(function () {
...
var resizeText = function resizeText(text, fontSize) {
...
},{"gsap":9}],9:[function(require,module,exports){
(function (global){
"use strict";
