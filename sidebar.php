    ...
    <div class="sidebar-inner">
        ...
        <section class="site-overview-wrap <?php  if($this->is('index'))  _e('sidebar-section-active'); ?>" text-center>
            ...
            <div class="cc-license" itemprop="license">
                <a href="https://creativecommons.org/licenses/by-nc-sa/4.0/deed.zh" class="cc-opacity" target="_blank"><img src="<?php $this->options->themeUrl('./img/cc-by-nc-sa.png'); ?>" alt="Creative Commons"></a>
            </div>
        </section>
    </div>
    <!-- <div class="sidebar-inner"> 
...
<?php if($this->is('post')||$this->is('page')): ?>
<script src="<?php $this->options->themeUrl('js/sidebar.min.js'); ?>"></script>
<?php endif; ?>
