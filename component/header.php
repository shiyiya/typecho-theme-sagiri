...
<head>
    ...
    <!-- CSS Style -->
    <link async rel="stylesheet" href="<? $this->options->themeUrl('./css/mix.min.css'); ?>" />
    <link async rel="stylesheet" type="text/css" href="<? $this->options->themeUrl('./css/iconfont.min.css'); ?>" />
    ...
    <? if (!empty($this->options->feature) && in_array('commentEmoji', $this->options->feature) && $this->allow('comment')) : ?>
        <link rel="stylesheet" href="<? $this->options->themeUrl('./js/lib/OwO/OwO.min.css'); ?>">
    <? endif; ?>
